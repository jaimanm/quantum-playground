  ...
  return (
    <div className="absolute left-full top-4 ml-4 flex flex-col items-center gap-2">
      ...
      <button
        onClick={onClear}
        disabled={!hasGates}
        className="w-8 h-8 rounded-full bg-red-600 hover:bg-red-500 disabled:opacity-20 disabled:cursor-not-allowed flex items-center justify-center transition-colors"
        title="Clear circuit"
      >
        <svg
