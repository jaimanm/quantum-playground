...
const RunPanel: React.FC<RunPanelProps> = ({ numQubits, gates }) => {
  ...
  return (
    <div className="mt-6 w-full max-w-4xl mx-auto rounded-lg border border-gray-700 bg-gray-800 p-4">
      {/* Header with Run button */}
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-bold text-cyan-400">Simulation Results</h2>
        <button
          onClick={handleRun}
