...
export const gateDefinitions: GateDefinition[] = [
  {
    ...
    numQubits: 1,
    hasParams: false,
    tooltip: 'Creates an equal superposition of |0⟩ and |1⟩. Like flipping a quantum coin!',
  },
  {
    type: 'X',
    name: 'Pauli-X',
    ...
    numQubits: 1,
    hasParams: false,
    tooltip: 'Flips |0⟩ to |1⟩ and vice versa. The quantum version of a NOT gate.',
  },
  {
    type: 'Y',
    name: 'Pauli-Y',
    ...
    numQubits: 1,
    hasParams: false,
    tooltip: 'Flips the qubit and adds a phase. Rotates around the Y-axis of the Bloch sphere.',
  },
  {
    type: 'Z',
    name: 'Pauli-Z',
  ...
  },
  {
    ...
    numQubits: 2,
    hasParams: false,
    tooltip: 'Flips the target qubit if the control qubit is |1⟩. Creates entanglement!',
  },
  {
    type: 'CZ',
    name: 'CZ',
  ...
  },
  {
    ...
    numQubits: 2,
    hasParams: false,
    tooltip: 'Swaps the states of two qubits. Exchanges their quantum information.',
  },
  {
    type: 'Toffoli',
    name: 'Toffoli',
    ...
    numQubits: 3,
    hasParams: false,
    tooltip: 'Flips the target if both control qubits are |1⟩. Universal quantum gate!',
  },
];
